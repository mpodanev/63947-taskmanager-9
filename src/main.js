const controlBtnWrap = `<section class="control__btn-wrap">
  <input
    type="radio"
    name="control"
...
const mainSearch = `<section class="main__search search container">
  <input
    type="text"
    id="search__input"
    class="search__input"
...
const mainFilter = `<section class="main__filter filter container">
  <input
    type="radio"
    id="filter__all"
...
mainControl.insertAdjacentHTML(`beforeend`, controlBtnWrap);

main.insertAdjacentHTML(`beforeend`, mainSearch);
main.insertAdjacentHTML(`beforeend`, mainFilter);
main.insertAdjacentHTML(`beforeend`, board);
